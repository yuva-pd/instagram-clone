...
//    useEffect(async () => {
//      let tenppostdata = await firestore().collection("posts").get();
//      let tenppostdatau = await firestore().collection("users").get();

//      console.log("Fdgergreesfs" + tenppostdata.docs.length);
//      console.log(tenppostdata.docs[0].data())
//      //   setlength(tenppostdata.docs.length);
//      // //   return tenppostdata;
//        // setPostdata(tenppostdata);
//        setpo(tenppostdata.docs.length);
//        console.log(po)
//      let dummy1 = [];
//      let dummy2 = [];
//      for (let i = 0; i < tenppostdata.docs.length; i++) {
//        dummy1.push(tenppostdatau.docs[i].data()["user"]);
//        dummy2.push(tenppostdata.docs[i].data()["profileUrl"]);
//      }
//      setUserNameList(dummy1);
//      setUserProfileList(dummy2);
//    }, []);

//    // console.log(len)

//    // console.log(postdata.docs.length)
//    const [userInput, setInput] = useState("");
//    const [todos, setTodos] = useState([]);
//    // console.log("qwertyuio"+postdata);
//    // console.log("DFEGRVEFDegr"+postdata.docs)
//    const [po, setpo] = useState([{}]);
//    const [Name, setName] = useState();
//    const [photo, setPhoto] = useState();
//    for (let i = 0; i < po.length; i++) {
//      //  postdata==undefined? null:console.log('post data is', postdata.docs)
//      {
//        po[i].data != undefined
//          ? (console.log(po[i].data().uid),
//            posts.push(
//              <View>
...
//                      }}>
//                        {userNameList[i] !=undefined ? (<Text style={{marginTop: 20, fontWeight: '500'}}>{userNameList[i]}</Text>):null}
...
//                  </View>
//                </View>
//                  <Image style={{height: 500, width: 390}} source={{uri:po[i].data().postUrl}} />
...
//                  <Text style={{marginLeft:25,fontWeight:'bold'}}>{po[i].data().text}</Text>
//                </View>
...
for(i=0;i<followingposts.length;i++){
  ...
  followingposts[i]["profileurl"]

  for(j=0;j<followingposts[i]["postes"].length;j++){
    followingposts[i]["postes"][j]["postUrl"]
  }
}
  ...
  for (let i = 0; i < followingposts.length; i++) {
    for (let j = 0; j < followingposts[i]["postes"].length; j++) {
      // followingpost.push(followingposts[i]["postes"][j]["postUrl"]);
      followingname.push(followingposts[i]["user"]);
    }
  }
  console.log("followingpost" + dummy1.length);
  ...
  function Scrolldata({ navigation }) {
    ...
    for (let i = 0; i < po; i++) {
      // console.log(tenppostdatau.docs[i].data());
          ...
          >
            <View style={{ flexDirection: "row" }}>
              ...
              >
                ...
                <Text style={{ marginTop: 20, fontWeight: "500" }}>{user}</Text>
              </TouchableOpacity>
            </View>
            <Text
              Text
